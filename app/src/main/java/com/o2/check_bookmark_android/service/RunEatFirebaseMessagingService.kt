package com.o2.check_bookmark_android.service
...
import com.o2.check_bookmark_android.ui.MainActivity
import com.o2.check_bookmark_android.R
import java.util.*


class RunEatFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        builder = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            if (notificationManager.getNotificationChannel("RunEat") == null) {
            ...
            NotificationCompat.Builder(applicationContext, "RunEat")
        } else {
